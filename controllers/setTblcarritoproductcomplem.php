...
if (!empty($_POST)){
     ...
     */
    $resultado = FuncionesBePickler::setTblcarritoproductcomplem($cantidad,$nombreproductcom,$nombreproveedor,$precioreal,$preciobp,$emailcreo,$idtblordencompra,$idtblproductcomplem);
