...
if (!empty($_POST)){
     ...
     */
    $resultado = FuncionesBePickler::setTblentregacomplem($nombreproveedor, $fchentre,$numproductpedidos,$numproductentregados,$status,$fchpagoproveedor,$srcimg1,$srcimg2,$emailcreo,$idtblordencompra,$idtblproveedor);
