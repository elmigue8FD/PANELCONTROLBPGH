...
if (!empty($_POST)){
     ...
     */
    $resultado = FuncionesBePickler::getAlltblproductoBytblcategproductFiltro($idtblcolonia,$idtbltipodeservicio,$fechapedido,$hora,$idtblcategproduct,$idtblclasifproduct);
