...
if (!empty($_POST)){
     ...
     */
    $resultado = FuncionesBePickler::setUpdateTtblentregacomplem($nombreproveedor,$fchentrega,$numproductpedidos,$numproductentregados,$status,$fchpagoproveedor,$srcimg1,$srcimg2,$emailmodifico,$idtblordencompra,$idtblproveedor);
