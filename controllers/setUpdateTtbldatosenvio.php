...
if (!empty($_POST)){
    ...
    $emailmodifo=$_POST["emailmodifo"];
    $idtblordencompra=$_POST["idtblordencompra"];
    /**
     * Mandamos los parámetros y llamamos a la función que ejecutara la sentencia y retorna el resultado.
     */
    $resultado = FuncionesBePickler::setUpdateTtbldatosenvio($tipodepedido,$tiposervicio,$calle,$numint,$fchagendado,$hragendado,$numext,$colonia,$ciudad,$pais,$codipost,$nombreempresa,$rfc,$nombrerecibe,$celularrecibe,$referencia1,$referencia2,$emailmodifo,$idtblordencompra);
