...
if (!empty($_POST)){
     ...
     */
    $resultado = FuncionesBePickler::getAlltblproductoBytblproveedorFiltro($idtblcolonia,$idtbltipodeservicio,$fechapedido,$hora,$idtblproveedor,$idtblclasifproduct);
