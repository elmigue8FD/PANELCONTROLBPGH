...
if (!empty($_POST)){
     ...
     */
    $resultado = FuncionesBePickler::setTblusuarioproveedor2($nombreproveedor, $apellidoproveedor, $emailproveedor, $celularproveedor,$activado,$idtblproveedor,$idtblnivelacceso,$password,$emailcreo);
