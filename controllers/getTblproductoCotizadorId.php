...
if (!empty($_POST)){
     ...
     */
    $resultado = FuncionesBePickler::getTblproductoCotizadorId($nombreproductcotizador, $descripcion,$ingrediente,$promcalificacion,$diaselaboracion,$activado,$idtblevento,$idtblproveedor,$emailcreo);
