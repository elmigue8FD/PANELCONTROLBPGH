...
if (!empty($_POST)){
    ...
    $idtblordenpaquete=$_POST["idtblordenpaquete"];
     ...
     */
    $resultado = FuncionesBePickler::setUpdateTblordenpaquete($idtblordenpaquete,$nombremodulo,$nombrepaquete,$precipoaquete,$statuspagado,$sistemapago,$facturacion,$token,$emailtoken,$nombreusuarioprov,$direccionusuarioprov,$email,$ciudad,$telefono,$idtblpaquete,$idtblpreproveedor,$emailcreo);
