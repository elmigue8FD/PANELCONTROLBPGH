...
if (!empty($_POST)){
   ...
   //*********************************************
     ...
     */
    $resultado = FuncionesBePickler::setTblentregaproducto($nombreproveedor,$fchentre,$numproductpedidos,$numproductentregados,$status,$descripcion,$statusdeposito,$fchcorte,$srcimg1,$srcimg2,$emailcreo,$idtblordencompra,$idtblproveedor,$fchpagoproveedor);
