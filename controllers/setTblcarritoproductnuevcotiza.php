...
if (!empty($_POST)){
    ...
    if($resultado==0)
    {
        $resultado = FuncionesBePickler::setTblcarritoproductnuevcotiza($numpersonas, $fchentrega, $srcimgproducto, $tipoevento, $sabores, $comentarios, $idtblordencotizador, $emailcreo);
        if($resultado){
            /**
