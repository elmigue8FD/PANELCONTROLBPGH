...
if (!empty($_POST)){
   ...
   // $direccion=$_POST["direccion"];
	 ...
	 */
    $resultado = FuncionesBePickler::setTblproveedor2($nombreprov,$srclogo,$descripcion,$direccion,$seo,$telftienda,$extencion,$celular,$email,$rfc,$clave,$banco,$titular,$activado,$idtbltipopedido,$idtbltiposervicio,$idtblcolonia,$idtblpaquete,$emailcreo);
