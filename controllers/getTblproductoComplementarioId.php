...
if (!empty($_POST)){
     ...
     */
    $resultado = FuncionesBePickler::getTblproductoComplementarioId($nombreproductcomplem, $descripcion, $seo, $precioreal, $preciobp, $srcimg,$activado,$idtblproveedor,$stock,$emailcreo);
