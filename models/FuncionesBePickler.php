...
*/
    ...
    /*Insertar un registro en el historico de cupon descuento*/
	 public static function setTblhistcupondescuento($cupondescuento, $descuento,$idtblcliente,$idtblordencompra,$idtblcupondescuento,$emailcreo){
        ...
        $insert ="INSERT INTO  tblhistcupondescuento (tblhistcupondescuento_cupon,tblhistcupondescuento_descuento, 	tblcupondescuento_idtblcupondescuento,tblhistcupondescuento_idtblcliente, tblhistcupondescuento_idtblordencompra, tblhistcupondescuento_fchmodificacion, tblhistcupondescuento_fchcreacion, tblhistcupondescuento_emailusuacreo, tblhistcupondescuento_emailusuamodifico) VALUES (?,?,?,?,?,NOW(),NOW(),?,?)"; 
        
        try{
			$resultado = ConexionDB::getInstance()->getDb()->prepare($insert);
			$resultado->bindParam(1,$cupondescuento,PDO::PARAM_STR);
			$resultado->bindParam(2,$descuento,PDO::PARAM_INT);
			$resultado->bindParam(3,$idtblcupondescuento,PDO::PARAM_INT);
			$resultado->bindParam(4,$idtblcliente,PDO::PARAM_INT);
			$resultado->bindParam(5,$idtblordencompra,PDO::PARAM_INT);
			$resultado->bindParam(6,$emailcreo,PDO::PARAM_STR);
			$resultado->bindParam(7,$emailcreo,PDO::PARAM_STR);
			$resultado->execute();
			return $resultado->rowCount(); //retorna el numero de registros afectado por el insert
    ...
    public static function getAllTblcategproductByFiltro($idtblcolonia,$tipodeservicio,$fechapedido,$hora){
        ...
        if($tipodeservicio==1){ //tipodeservicio Pasteleria (se considera al colonia)
        	...
        	$consulta ="SELECT TCPT.* FROM  tblhora THs, tblproveedor TPR  
 		INNER JOIN tblcolonia TCA ON TCA.idtblcolonia = TPR.tblcolonia_idtblcolonia
        INNER JOIN tblciudad TCD ON TCD.idtblciudad = TCA.tblciudad_idtblciudad
 		INNER JOIN tblproducto TPO ON TPR.idtblproveedor = TPO.tblproveedor_idtblproveedor
 		INNER JOIN tblproductdetalle TPOD ON TPO.idtblproducto = TPOD.tblproducto_idtblproducto
		...
		INNER JOIN tblhora THa ON THa.idtblhora = TA.tblhora_idtblhora 
		INNER JOIN tblhora THc ON THc.idtblhora = TC.tblhora_idtblhora
        INNER JOIN tblcategproduct TCPT ON TPO.tblcategproduct_idtblcategproduct = TCPT.idtblcategproduct
		WHERE 
				TCD.tblciudad_activado = ?
		    AND TCA.tblcolonia_activado = ?
		    AND TPR.tblproveedor_activado=?
		    ...
		    AND TCA.idtblcolonia = ?
            AND CAST( ? AS TIME) BETWEEN THa.tblhora_hora AND THc.tblhora_hora
            GROUP BY TCPT.idtblcategproduct";
   ...
   WHERE OC.tblordencompra_statuspagado=1 AND ENV.tbldatosenvio_ciudad= ? ";
	...
	public static function getAllTblcarritoproductByidorden($idtblordencompra,$idtblproveedor){
		...
		$consulta = "SELECT TP.*,TCP.*,TPD.*,TPI.* FROM tblcarritoproduct TCP		             
       				 INNER JOIN tblordencompra TOC ON  TCP.tblcarritoproduct_idtblordencompra = TOC.idtblordencompra  
      				 INNER JOIN tblproductdetalle TPD ON TPD.idtblproductdetalle = TCP.tblcarritoproduct_idtblproductdetalle
      				 INNER JOIN tblproducto TP ON TP.idtblproducto = TPD.tblproducto_idtblproducto 
      				 INNER JOIN tblproductimg TPI ON TPI.tblproducto_idtblproducto = TP.idtblproducto     				 
   ...
   WHERE OC.tblordencompra_statuspagado=0 AND OC.idtblordencompra= ?
	...
	/*Obtiene todos los registro de tblusuarioproveedor*/
    public static function getAllTblusuarioproveedorDatos(){
	    
		$consulta = "SELECT U.*,P.*,N.*,CI.* FROM tblusuarioproveedor U
		INNER JOIN tblproveedor P ON P.idtblproveedor=U.tblproveedor_idtblproveedor
		INNER JOIN tblcolonia C ON C.idtblcolonia=P.tblcolonia_idtblcolonia
		INNER JOIN tblciudad CI ON CI.idtblciudad=C.tblciudad_idtblciudad
		INNER JOIN tblniveleacceso N ON N.idtblniveleacceso=U.tblniveleacceso_idtblniveleacceso";
	...
	/*Insertar un registro en tblusuarioproveedor*/
	 public static function setTblusuarioproveedor2($nombreproveedor, $apellidoproveedor, $emailproveedor, $celularproveedor,$activado,$idtblproveedor,$idtblnivelacceso,$password,$emailcreo){
	...
	/*Actualizar el estatus de un registro en tblusuariosproveedor*/
	 public static function setUpdateTblusuariosproveedorEstatus($idtblusuario,$activado,$emailmodifico){
        
        $insert ="UPDATE tblusuarioproveedor SET tblusuarioproveedor_activado = ?,tblusuarioproveedor_fchmodificacion = NOW(),
		          tblusuarioproveedor_emailusuamodifico = ? WHERE idtblusuarioproveedor= ?"; 
        
        try{
			$resultado = ConexionDB::getInstance()->getDb()->prepare($insert);			
			$resultado->bindParam(1,$activado,PDO::PARAM_INT);			
			$resultado->bindParam(2,$emailmodifico,PDO::PARAM_STR);
			$resultado->bindParam(3,$idtblusuario,PDO::PARAM_INT);
			$resultado->execute();
			return $resultado->rowCount(); //retorna el numero de registros afectado por el insert
		} catch(PDOException $e){
			return false;
	...
	/*Obtiene un registro de tblusuarioproveedor con nombre de proveedor y ciudad*/
   
    public static function getAllTblusuarioproveedorDatos2($idtblusuarioproveedor){
	...
	/*Actualizar un registro en tblusuarioproveedor (sin el estatus y contraseña)*/
	 public static function setUpdateTblusuarioproveedorSinEst($idtblusuarioproveedor,$nombreproveedor, $apellidoproveedor, $emailproveedor, $celularproveedor,$idtblproveedor,$idtblnivelacceso,$emailmodifico){
        
        $update ="UPDATE tblusuarioproveedor SET tblusuarioproveedor_nombre = ?,
		          tblusuarioproveedor_apellido = ?,tblusuarioproveedor_email = ?,
				  tblusuarioproveedor_celular = ?,tblproveedor_idtblproveedor = ?,
				  tblniveleacceso_idtblniveleacceso = ?,
				  tblusuarioproveedor_fchmodificacion = NOW(),
				  tblusuarioproveedor_emailusuamodifico = ? WHERE idtblusuarioproveedor = ?"; 
        ...
        try{
			...
			$resultado->bindParam(3,$emailproveedor,PDO::PARAM_STR);
			$resultado->bindParam(4,$celularproveedor,PDO::PARAM_STR);			
			$resultado->bindParam(5,$idtblproveedor,PDO::PARAM_INT);
			$resultado->bindParam(6,$idtblnivelacceso,PDO::PARAM_INT);			
			$resultado->bindParam(7,$emailmodifico,PDO::PARAM_STR);
			$resultado->bindParam(8,$idtblusuarioproveedor,PDO::PARAM_INT);
			$resultado->execute();
			return $resultado->rowCount(); //retorna el numero de registros afectado por el insert
		} catch(PDOException $e){
			return false;
	...
	/*Actualizar un registro en tblusuarioproveedor (sin el estatus)*/
	 public static function setUpdateTblusuarioproveedorSinEst2($idtblusuarioproveedor,$nombreproveedor, $apellidoproveedor, $emailproveedor, $celularproveedor,$idtblproveedor,$idtblnivelacceso,$pass,$emailmodifico){
        
        $update ="UPDATE tblusuarioproveedor SET tblusuarioproveedor_nombre = ?,
		          tblusuarioproveedor_apellido = ?,tblusuarioproveedor_email = ?,
				  tblusuarioproveedor_celular = ?,tblproveedor_idtblproveedor = ?,
				  tblniveleacceso_idtblniveleacceso = ?,tblusuarioproveedor_password=?,
				  tblusuarioproveedor_fchmodificacion = NOW(),
				  tblusuarioproveedor_emailusuamodifico = ? WHERE idtblusuarioproveedor = ?"; 
        ...
        try{
			...
			$resultado->bindParam(5,$idtblproveedor,PDO::PARAM_INT);
			$resultado->bindParam(6,$idtblnivelacceso,PDO::PARAM_INT);
            $resultado->bindParam(7,$pass,PDO::PARAM_STR);			
			$resultado->bindParam(8,$emailmodifico,PDO::PARAM_STR);
			$resultado->bindParam(9,$idtblusuarioproveedor,PDO::PARAM_INT);
			$resultado->execute();
			return $resultado->rowCount(); //retorna el numero de registros afectado por el insert
		} catch(PDOException $e){
			return false;
	...
	/*Borrar un registro en tblusuarioproveedor (vacia datos)*/
	 public static function DeleteTblusuarioproveedorDatos($idtblusuarioproveedor,$emailproveedor,$celularproveedor,$activado,$emailmodifico){
        
        $update ="UPDATE tblusuarioproveedor SET tblusuarioproveedor_email = ?,
				  tblusuarioproveedor_celular = ?,tblusuarioproveedor_activado = ?,
				  tblusuarioproveedor_fchmodificacion = NOW(),
				  tblusuarioproveedor_emailusuamodifico = ? WHERE idtblusuarioproveedor = ?"; 
        ...
        try{
			$resultado = ConexionDB::getInstance()->getDb()->prepare($update);			
			$resultado->bindParam(1,$emailproveedor,PDO::PARAM_STR);
			$resultado->bindParam(2,$celularproveedor,PDO::PARAM_STR);			
			$resultado->bindParam(3,$activado,PDO::PARAM_INT);			
			$resultado->bindParam(4,$emailmodifico,PDO::PARAM_STR);
			$resultado->bindParam(5,$idtblusuarioproveedor,PDO::PARAM_INT);
			$resultado->execute();
			return $resultado->rowCount(); //retorna el numero de registros afectado por el insert
		} catch(PDOException $e){
			return false;
    ...
    */
	...
	public static function getAllTblciudadFiltro($idtblpais,$fechapedido){
	...
	/*Funciona para obtener las colonias para el Filtro App*/
	...
	/*Obtiene las horas para filtro App*/
	...
	public static function getAlltblproductoBytblcategproductFiltro($idtblcolonia,$idtbltipodeservicio,$fechapedido,$hora,$idtblcategproduct,$idtblclasifproduct){
		...
		INNER JOIN tblhora THa ON THa.idtblhora = TA.tblhora_idtblhora 
		INNER JOIN tblhora THc ON THc.idtblhora = TC.tblhora_idtblhora
        INNER JOIN tblclasifproduct TCLP ON TCLP.idtblclasifproduct = TPO.tblclasifproduct_idtblclasifproduct
        INNER JOIN tblcategproduct TCPT ON TPO.tblcategproduct_idtblcategproduct = TCPT.idtblcategproduct
		...
		WHERE 
		    ...
		    AND TCA.idtblcolonia = ?
            AND CAST( ? AS TIME) BETWEEN THa.tblhora_hora AND THc.tblhora_hora
            AND TCPT.idtblcategproduct = ?
            AND TCLP.idtblclasifproduct = ?
        ...
        try{
            	...
            	$resultado->bindParam(12,$idtblcolonia,PDO::PARAM_INT);
            	$resultado->bindParam(13,$hora,PDO::PARAM_STR);
            	$resultado->bindParam(14,$idtblcategproduct,PDO::PARAM_INT);
            	$resultado->bindParam(15,$idtblclasifproduct,PDO::PARAM_INT);
            	$resultado->execute();
                return $resultado->fetchAll(PDO::FETCH_ASSOC); //retorna los campos del registro
            } catch(PDOException $e){
                    return false;   
        ...
        try{
            	...
            	$resultado->bindParam(11,$diasemana,PDO::PARAM_STR);
            	$resultado->bindParam(12,$hora,PDO::PARAM_STR);
            	$resultado->bindParam(13,$idtblcategproduct,PDO::PARAM_INT);
	...
	public static function getAlltblproductoBytblproveedorFiltro($idtblcolonia,$idtbltipodeservicio,$fechapedido,$hora,$idtblproveedor,$idtblclasifproduct){
        ...
        try{
            	...
            	$resultado->bindParam(11,$hora,PDO::PARAM_STR);
            	$resultado->bindParam(12,$idtblproveedor,PDO::PARAM_INT);
            	$resultado->bindParam(13,$idtblclasifproduct,PDO::PARAM_INT);
            	$resultado->execute();
                return $resultado->fetchAll(PDO::FETCH_ASSOC); //retorna los campos del registro
            } catch(PDOException $e){
                    return false;      
