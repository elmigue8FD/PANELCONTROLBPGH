...
if (isset($_FILES["srcimg1_producto"]))
{
    ...
    else
    {
        ...
        echo "se subio iamgen 1";
    }
}
else
{
    echo 'Error no tiene datos file1';
}
/**
 * 
 */
if (isset($_FILES["srcimg2_producto"]))
{
    ...
    else
    {
        $src = $carpeta.$nombre;
        move_uploaded_file($ruta_provisional, $src);
        echo "se subio iamgen 2";
    }
}
else
{
    echo 'Error no tiene datos file2';
}
/**
 * 
 */
if (isset($_FILES["srcimg3_producto"]))
{
    ...
    else
    {
        $src = $carpeta.$nombre;
        move_uploaded_file($ruta_provisional, $src);
        echo "se subio iamgen 3";
    }
}
else
{
    echo 'Error no tiene datos file3';
}
