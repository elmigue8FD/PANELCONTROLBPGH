<ul>
    <li  id="Inicio" name="menuSection" title="Inicio">
        <a href="inicio.php">
    ...
    <li title="PerfilTienda" id="PerfilTienda" name="menuSection" >
        <a href="perfilTienda.php">
            <span class="menu_icon"><i class="material-icons">&#xE8D1;</i></span>
            <span class="menu_title">Perfil Tienda</span>
        </a>
